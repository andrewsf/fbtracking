/*1447128477,,JIT Construction: v2034042,en_US*/
...
try {
        ...
        for (var i = 0; i < sandboxWhitelist.length; i++) {
            ...
            with(this) {
                ...
                __d("JSON3", [], function a(b, c, d, e, f, g) {
                    ...
                    (function() {
                        var h = {}.toString,
                            i, j, k, l = f.exports = {}, m = '{"A":[1,true,false,null,"\\u0000\\b\\n\\f\\r\\t"]}',
                        ...
                        if (!n || !s) {
                            ...
                            j = function(ha, ia) {
                                ...
                                if (!ja) {
                                    ...
                                    na = function(oa, pa) {
                                        var qa = {}, ra = h.call(oa) == "[object Function]",
                                            sa;
                            ...
                            if (!n) {
                                ...
                                q = function(ha) {
                                    var ia = '"',
                                        ja = 0,
                                        ka;
                                    for (; ka = ha.charAt(ja); ja++) ia += '\\"\b\f\n\r\t'.indexOf(ka) > -1 ? o[ka] : ka < " " ? "\\u00" + p(2, ka.charCodeAt(0)
                                        .toString(16)) : ka;
                                    return ia + '"';
                                };
                ...
                __d('ES6DatePrototype', [], function a(b, c, d, e, f, g) {
                    ...
                    var i = {
                        toISOString: function() {
                            ...
                            j = (j < 0 ? '-' : j > 9999 ? '+' : '') + ('00000' + Math.abs(j))
                                .slice(0 <= j && j <= 9999 ? -4 : -6);
                            return j + '-' + h(this.getUTCMonth() + 1) + '-' + h(this.getUTCDate()) + 'T' + h(this.getUTCHours()) + ':' + h(this.getUTCMinutes()) + ':' + h(this.getUTCSeconds()) + '.' + (this.getUTCMilliseconds() / 1000)
                                .toFixed(3)
                                .slice(2, 5) + 'Z';
                        }
                    };
                ...
                __d('ES', ['ES5ArrayPrototype', 'ES5FunctionPrototype', 'ES5StringPrototype', 'ES5Array', 'ES5Object', 'ES5Date', 'JSON3', 'ES6Object', 'ES6ArrayPrototype', 'ES6DatePrototype', 'ES6Number', 'ES7StringPrototype'], function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s) {
                    ...
                    function z(aa, ba, ca) {
                        ...
                        } else if (ea) return ea;
                        throw new Error('Polyfill ' + da + ' does not have implementation of ' + ba);
                    }
                    f.exports = z;
                }, null);
                ...
                __d("JSSDKXDConfig", [], {
                    ...
                    "XdBundleUrl": "\/connect\/xd_arbiter\/wjDNIDNrTQG.js?version=41",
                    "Flash": {
                ...
                __d('QueryString', [], function a(b, c, d, e, f, g) {
                    ...
                    function h(l) {
                        var m = [];
                        ES(ES('Object', 'keys', false, l)
                            .sort(), 'forEach', true, function(n) {
                            var o = l[n];
                ...
                __d('Type', ['Assert'], function a(b, c, d, e, f, g, h) {
                    ...
                    function k(m, n) {
                        ...
                        for (var p = 0; p < n.length; p++) {
                            ...
                            ES(Object.keys(q), 'forEach', true, function(r) {
                                o[r] = q[r];
                            });
                        }
                    }
                ...
                __d('sdk.Model', ['Type', 'ObservableMixin'], function a(b, c, d, e, f, g, h, i) {
                    ...
                    var j = h.extend({
                        constructor: function(k) {
                            this.parent();
                            var l = {}, m = this;
                            ES(Object.keys(k), 'forEach', true, function(n) {
                                l[n] = k[n];
                                m['set' + n] = function(o) {
                ...
                __d('sdk.UA', [], function a(b, c, d, e, f, g) {
                    ...
                    var p = {};
                    ES(Object.keys(k), 'map', true, function(q) {
                        p[q] = function() {
                    ...
                    ES(Object.keys(i), 'map', true, function(q) {
                        p[q] = function() {
                            return i[q];
                        };
                    });
                ...
                __d('ex', ['eprintf'], function a(b, c, d, e, f, g, h) {
                    ...
                    var i = function() {
                        ...
                        if (k[0].split('%s')
                            .length !== k.length) return i('ex args number mismatch: %s', ES('JSON', 'stringify', false, k));
                ...
                __d('sdk.Impressions', ['sdk.Content', 'Miny', 'QueryString', 'sdk.Runtime', 'UrlMap', 'getBlankIframeSrc', 'guid', 'insertIframe'], function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o) {
                    ...
                    function p(r) {
                        ...
                        var t = l.resolve('www', true) + '/impression.php/' + n() + '/',
                            u = j.appendToUrl(t, r);
                        if (u.length > 2000) if (r.payload && typeof r.payload === 'string') {
                ...
                __d('sdk.Scribe', ['QueryString', 'sdk.Runtime', 'UrlMap'], function a(b, c, d, e, f, g, h, i, j) {
                    ...
                    function k(m, n) {
                        ...
                        new Image()
                            .src = h.appendToUrl(j.resolve('www', true) + '/common/scribe_endpoint.php', {
                            c: m,
                ...
                __d('sdk.XD', ['sdk.Content', 'sdk.Event', 'Log', 'QueryString', 'Queue', 'sdk.RPC', 'sdk.Runtime', 'sdk.Scribe', 'sdk.URI', 'UrlMap', 'JSSDKXDConfig', 'XDM', 'isFacebookURI', 'sdk.createIframe', 'sdk.feature', 'guid'], function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w) {
                    ...
                    function qa(ua, va) {
                        ...
                        if (!va) if (ua.xd_sig == ca) va = ua.xd_origin;
                        if (ua.xd_action) {
                            pa(ua, va);
                            return;
                        }
                ...
                __d('sdk.Auth', ['sdk.Cookie', 'sdk.createIframe', 'DOMWrapper', 'sdk.feature', 'sdk.getContextType', 'guid', 'sdk.Impressions', 'Log', 'ObservableMixin', 'sdk.Runtime', 'sdk.SignedRequest', 'UrlMap', 'sdk.URI', 'sdk.XD'], function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u) {
                    ...
                    function ba(ea) {
                        ...
                        var ha = aa(ea, v, 'login_status'),
                            ia = new t(s.resolve('www', true) + '/connect/ping')
                                .setQueryData({
                ...
                __d('sdk.DOM', ['Assert', 'sdk.UA', 'createArrayFromMixed', 'sdk.domReady'], function a(b, c, d, e, f, g, h, i, j, k) {
                    ...
                    function s(aa, ba) {
                        ...
                        aa.className = ES(o(aa, 'className')
                            .replace(ca, ''), 'trim', true);
                    }
                    function t(aa, ba, ca) {
                        h.isString(aa);
                        ba = ba || document.body;
                    ...
                    function r(v, w) {
                        return function() {
                            ...
                            try {
                                ...
                                y.args = ES('JSON', 'stringify', false, z)
                                    .substring(0, 200);
                                p(y);
                            } finally {
                                o = '';
                ...
                __d('FB', ['sdk.Auth', 'JSSDKCssConfig', 'dotAccess', 'sdk.domReady', 'sdk.DOM', 'sdk.ErrorHandling', 'sdk.Content', 'DOMWrapper', 'GlobalCallback', 'sdk.Insights', 'Log', 'sdk.Runtime', 'sdk.Scribe', 'JSSDKConfig'], function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u) {
                    ...
                    function ca(da, ea) {
                        ...
                        ES(Object.keys(ea), 'forEach', true, function(ga) {
                            var ha = ea[ga];
                ...
                __d('ApiClient', ['ArgumentError', 'Assert', 'CORSRequest', 'FlashRequest', 'flattenObject', 'JSONPRequest', 'Log', 'ObservableMixin', 'QueryString', 'sprintf', 'sdk.URI', 'UrlMap', 'ApiClientConfig', 'invariant'], function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u) {
                    ...
                    function na() {
                        ...
                        var wa = ma(ua),
                            ...
                            ab = za.method;
                        if (sa(xa, ab)) ab = 'post';
                        var bb = xa.getProtocol() && xa.getDomain() ? xa.setQueryData({})
                            .toString() : s.resolve('graph') + xa.getPath();
                    ...
                    function oa() {
                        ...
                        var wa = ma(ua),
                            ...
                            ab = {
                                method: za,
                                relative_url: xa.removeQueryData('method')
                                    .toString()
                            };
                        if (za.toLowerCase() == 'post') {
                            ab.body = p.encode(xa.getQueryData());
                            ab.relative_url = xa.setQueryData({})
                                .toString();
                        }
                        ca.push(ab);
                        da.push(ya);
                ...
                __d('sdk.Dialog', ['sdk.Canvas.Environment', 'sdk.Content', 'sdk.DOM', 'DOMEventListener', 'ObservableMixin', 'sdk.Runtime', 'Type', 'sdk.UA', 'sdk.fbt', 'sdk.feature'], function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q) {
                    ...
                    function w() {
                        if (q('dialog_resize_refactor', false)) {
                            ...
                            if (z.height && z.width) return {
                                width: Math.min(z.width, t),
                                height: Math.min(z.height, s)
                            };
                        }
                        return null;
                    }
                    var x = n.extend({
                        ...
                        trackEvents: function(z) {
                            ...
                            for (var aa in z) if (z.hasOwnProperty(aa)) this.trackEvent(aa, z[aa]);
                            return this;
                        }
                    }, l),
                        y = {
                            ...
                            _setDialogSizes: function() {
                                ...
                                if (!o.mobile()) return;
                                for (var aa in y._dialogs) if (y._dialogs.hasOwnProperty(aa)) {
                                    var ba = document.getElementById(aa);
                                    if (ba) {
                                        ba.style.width = y.getDefaultSize()
                                            .width + 'px';
                                        if (!z) ba.style.height = y.getDefaultSize()
                                            .height + 'px';
                                    }
                                }
                            },
                            getDefaultSize: function() {
                                if (o.mobile()) {
                                    var z = w();
                                    if (z) {
                                        if (j.getViewportInfo()
                                            .width <= z.width) z.width = j.getViewportInfo()
                                            .width - r;
                                        if (j.getViewportInfo()
                                            .height <= z.height) z.height = j.getViewportInfo()
                                            .height - r;
                                        return z;
                                    }
                                    if (o.ipad()) return {
                            ...
                            _handleOrientationChange: function(z) {
                                var aa = q('dialog_resize_refactor', false) ? j.getViewportInfo()
                                    .width : screen.availWidth;
                                ...
                                if (y.isTabletStyle()) {
                                    ...
                                    var ba = y.getDefaultSize()
                                        .width;
                                    for (var ca in y._dialogs) if (y._dialogs.hasOwnProperty(ca)) {
                            ...
                            _addOrientationHandler: function() {
                                ...
                                y._availScreenWidth = q('dialog_resize_refactor', false) ? j.getViewportInfo()
                                    .width : screen.availWidth;
                            ...
                            show: function(z) {
                                ...
                                if (aa) {
                                    ...
                                    y._makeActive(aa);
                                    y._stack.push(aa);
                                    if ('fbCallID' in z) y.get(z.fbCallID)
                                        .inform('iframe_show')
                                        .trackEvent('show');
                                }
                            },
                ...
                __d('sdk.UIServer', ['sdk.Auth', 'sdk.Content', 'sdk.DOM', 'sdk.Dialog', 'sdk.Event', 'sdk.Frictionless', 'Log', 'sdk.Native', 'QueryString', 'sdk.RPC', 'sdk.Runtime', 'JSSDKConfig', 'sdk.UA', 'UrlMap', 'sdk.XD', 'createObjectFrom', 'sdk.feature', 'flattenObject', 'sdk.getContextType', 'guid', 'insertIframe', 'resolveURI'], function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, aa, ba, ca) {
                    ...
                    var ia = {
                        ...
                        checkOauthDisplay: function(ja) {
                            ...
                            var la = ka.split(/\s|,/g);
                            for (var ma = 0; ma < la.length; ma++) if (!s.initSitevars.iframePermissions[ES(la[ma], 'trim', true)]) return 'popup';
                            return ja.display;
                        },
                        prepareCall: function(ja, ka) {
                            var la = ja.method.toLowerCase(),
                                ma = ia.Methods.hasOwnProperty(la) ? ES('Object', 'assign', false, {}, ia.Methods[la]) : {}, na = aa(),
                            ...
                            if (la === 'share' || la === 'share_open_graph') if (ja.iframe_test) ma = ES('Object', 'assign', false, {}, da);
                        ...
                        getDisplayMode: function(ja, ka) {
                            ...
                            if (ka.display == 'iframe' || ka.display == 'dialog') if (!ia.canIframe(ka)) {
                        ...
                        canIframe: function(ja) {
                            ...
                            if (t.mobile() && r.getLoginStatus() === 'not_authorized') return !!ja.iframe_test;
                            return false;
                        },
                        getXdRelation: function(ja) {
                            var ka = ja.display;
                        ...
                        _popupMonitor: function() {
                            var ja;
                            for (var ka in ia._loadedNodes) if (ia._loadedNodes.hasOwnProperty(ka) && ka in ia._defaultCb) {
                ...
                __d('legacy:fb.canvas-legacy', ['Assert', 'FB', 'Log', 'sdk.Canvas.Tti'], function a(b, c, d, e, f, g, h, i, j, k) {
                    if (c.__markCompiled) c.__markCompiled();
                    i.provide('CanvasInsights', {
                        setDoneLoading: function(l) {
                            j.warn('Deprecated: use FB.Canvas.setDoneLoading');
                            h.maybeFunction(l, 'Invalid argument');
                ...
                __d('sdk.Canvas.Prefetcher', ['sdk.api', 'createArrayFromMixed', 'JSSDKCanvasPrefetcherConfig', 'sdk.Runtime'], function a(b, c, d, e, f, g, h, i, j, k) {
                    ...
                    function q() {
                        ...
                        if (o == l.AUTOMATIC) ES(Object.keys(v), 'forEach', true, function(w) {
                            var x = v[w];
                ...
                __d('legacy:fb.compat.ui', ['FB', 'Log', 'sdk.ui', 'sdk.UIServer'], function a(b, c, d, e, f, g, h, i, j, k) {
                    if (c.__markCompiled) c.__markCompiled();
                    h.provide('', {
                        share: function(l) {
                ...
                __d("mergeArrays", [], function a(b, c, d, e, f, g) {
                    ...
                    function h(i, j) {
                        for (var k = 0; k < j.length; k++) if (ES(i, "indexOf", true, j[k]) < 0) i.push(j[k]);
                        return i;
                    }
                    f.exports = h;
                }, null);
                ...
                __d('safeEval', [], function a(b, c, d, e, f, g) {
                    ...
                    function h(i, j) {
                        ...
                        return Function('return eval("' + i.replace(/"/g, '\\"') + '");')
                            .apply(null, j || []);
                    }
                    f.exports = h;
                }, null);
                ...
                __d('sdk.Query', ['format', 'safeEval', 'Type', 'sdk.Waitable'], function a(b, c, d, e, f, g, h, i, j, k) {
                    ...
                    var o = 1,
                        p = k.extend({
                            ...
                            hasDependency: function(q) {
                                if (arguments.length) this._hasDependency = q;
                                return !!this._hasDependency;
                            },
                            parse: function(q) {
                                var r = h.apply(null, q),
                                    s = /^select (.*?) from (\w+)\s+where (.*)$/i.exec(r);
                                this.fields = l(s[1]);
                                this.table = s[2];
                                this.where = m(s[3]);
                                for (var t = 1; t < q.length; t++) if (j.instanceOf(p, q[t])) q[t].hasDependency(true);
                                return this;
                            },
                            toFql: function() {
                                var q = 'select ' + this.fields.join(',') + ' from ' + this.table + ' where ';
                                switch (this.where.type) {
                                case 'unknown':
                                    q += this.where.value;
                                    break;
                                case 'index':
                                    q += this.where.key + '=' + n(this.where.value);
                                    break;
                                case 'in':
                                    if (this.where.value.length == 1) {
                                        q += this.where.key + '=' + n(this.where.value[0]);
                                    } else q += this.where.key + ' in (' + ES(this.where.value, 'map', true, n)
                                        .join(',') + ')';
                                    break;
                                }
                                return q;
                ...
                __d('sdk.Data', ['sdk.api', 'sdk.ErrorHandling', 'mergeArrays', 'sdk.Query', 'safeEval', 'sdk.Waitable'], function a(b, c, d, e, f, g, h, i, j, k, l, m) {
                    if (c.__markCompiled) c.__markCompiled();
                    var n = {
                        query: function(o, p) {
                            var q = new k()
                        ...
                        waitOn: function(o, p) {
                            ...
                            if (typeof p == 'string') {
                                var s = p;
                                p = i.unguard(function() {
                                    return l(s);
                                });
                            }
                            ES(o, 'forEach', true, function(t) {
                                t.monitor('Value.change', function() {
                                    ...
                                    if (r === 0) {
                                        var v = p(ES(o, 'map', true, n._getValue));
                        ...
                        _process: function(o) {
                            ...
                            h('/fql', 'GET', t, function(v) {
                                if (v.error) {
                                    ES(Object.keys(p), 'forEach', true, function(w) {
                                        p[w].error(new Error(v.error.message));
                                    });
                                } else ES(v.data, 'forEach', true, function(w) {
                        ...
                        _mergeIndexQuery: function(o, p) {
                            ...
                            j(t.where.value, [r]);
                            t.wait(function(u) {
                                o.setValue(ES(u, 'filter', true, function(v) {
                                    return v[q] == r;
                                }));
                            });
                        },
                ...
                __d('legacy:fb.data', ['FB', 'sdk.Data'], function a(b, c, d, e, f, g, h, i) {
                    if (c.__markCompiled) c.__markCompiled();
                    h.provide('Data', i);
                }, 3);
                ...
                __d('sdk.init', ['sdk.Cookie', 'sdk.ErrorHandling', 'sdk.Event', 'Log', 'ManagedError', 'sdk.PlatformVersioning', 'QueryString', 'sdk.Runtime', 'sdk.URI', 'createArrayFromMixed', 'sdk.feature'], function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r) {
                    if (c.__markCompiled) c.__markCompiled();
                    ...
                    function t(u) {
                        ...
                        if (o.getIsVersioned()) {
                            if (Object.prototype.toString.call(u) !== '[object Object]') throw new l('Invalid argument');
                            if (u.authResponse) k.warn('Setting authResponse is not supported');
                            if (!u.version) u.version = new p(location.href)
                                .getQueryData()
                                .sdk_version;
                            m.assertValidVersion(u.version);
                            o.setVersion(u.version);
                        } else {
                        ...
                        if (v !== null) o.setClientID(v);
                        if ('scope' in u) o.setScope(u.scope);
                        if (u.cookie) {
                            o.setUseCookie(true);
                            if (typeof u.cookie === 'string') h.setDomain(u.cookie);
                        }
                        if (u.kidDirectedSite) o.setKidDirectedSite(true);
                        o.setInitialized(true);
                        if (r('js_sdk_force_status_on_load', false)) u.status = true;
                        j.fire('init:post', u);
                    }
                    setTimeout(function() {
                        var u = /(connect\.facebook\.net|\.facebook\.com\/assets.php).*?#(.*)/;
                        ES(q(document.getElementsByTagName('script')), 'forEach', true, function(v) {
                            if (v.src) {
                                var w = u.exec(v.src);
                                if (w) {
                                    var x = n.decode(w[2]);
                ...
                __d('legacy:fb.json', ['FB', 'ManagedError'], function a(b, c, d, e, f, g, h, i) {
                    ...
                    h.provide('JSON', {
                        stringify: function(j) {
                            try {
                                return ES('JSON', 'stringify', false, j);
                            } catch (k) {
                                throw new i(k.message, k);
                            }
                        },
                        parse: function(j) {
                            try {
                                return ES('JSON', 'parse', false, j);
                            } catch (k) {
                                throw new i(k.message, k);
                            }
                        }
                ...
                __d('legacy:fb.ua', ['FB', 'sdk.UA'], function a(b, c, d, e, f, g, h, i) {
                    if (c.__markCompiled) c.__markCompiled();
                    h.provide('UA', {
                ...
                __d('XFBML', ['Assert', 'sdk.DOM', 'Log', 'ObservableMixin', 'sdk.UA', 'createArrayFromMixed', 'runOnce'], function a(b, c, d, e, f, g, h, i, j, k, l, m, n) {
                    ...
                    function u(z) {
                        return o[s(z, 'nodeName')
                            .toLowerCase()] || o[t(z)
                            .toLowerCase()];
                    }
                    function v(z) {
                        var aa = ES(s(z, 'className')
                            .split(/\s+/), 'filter', true, function(ba) {
                ...
                __d('IframePlugin', ['sdk.Auth', 'sdk.DOM', 'sdk.Event', 'Log', 'ObservableMixin', 'sdk.PlatformVersioning', 'PluginPipe', 'QueryString', 'sdk.Runtime', 'Type', 'sdk.UA', 'sdk.URI', 'UrlMap', 'sdk.XD', 'sdk.createIframe', 'sdk.feature', 'guid', 'resolveURI'], function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y) {
                    ...
                    function ea(ia, ja, ka, la) {
                        ES(Object.keys(ia), 'forEach', true, function(ma) {
                            if (ia[ma] == 'text' && !ka[ma]) {
                    ...
                    var ha = q.extend({
                        ...
                        process: function() {
                            if (p.getIsVersioned()) {
                                ...
                                this._iframeOptions.url = ia.setPath('/' + p.getVersion() + ia.getPath())
                                    .toString();
                            }
                        ...
                        reposition: function(ia) {
                            var ja = i.getPosition(this._iframe)
                                .x,
                                ka = i.getViewportInfo()
                                    .width,
                ...
                __d('PluginTags', [], function a(b, c, d, e, f, g) {
                    ...
                    ES(Object.keys(i), 'forEach', true, function(j) {
                        h[j] = h[i[j]];
                    });
                    f.exports = h;
                }, null);
                    ...
                    var p = i.extend({
                        ...
                        setupAndValidate: function() {
                            ...
                            if (!q.href) {
                                ...
                                if (!s) {
                                    s = j.decode(document.URL.substring(ES(document.URL, 'indexOf', true, '?') + 1))
                                        .fb_comment_id;
                ...
                __d('legacy:fb.xfbml', ['Assert', 'sdk.Event', 'FB', 'IframePlugin', 'PluginConfig', 'PluginTags', 'XFBML', 'sdk.domReady', 'sdk.feature', 'wrapFunction', 'sdk.XFBML.Comments', 'sdk.XFBML.CommentsCount', 'sdk.XFBML.LoginButton', 'sdk.XFBML.Name', 'sdk.XFBML.ShareButton', 'sdk.XFBML.Video'], function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q) {
                    ...
                    ES(Object.keys(m), 'forEach', true, function(u) {
                    ...
                    ES(Object.keys(r), 'forEach', true, function(u) {
                        if (ES(s, 'indexOf', true, u) !== -1) return;
                        n.registerTag({
                            xmlns: 'fb',
                            localName: u.replace(/_/g, '-'),
    ...
    new Image()
        .src = "http:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script) + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"2034042","message":"' + e.message + '"}}');
}
