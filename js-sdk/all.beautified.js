    ...
    window.FB || (function(window) {
            ...
            function p(t, u) {
                return function() {
                    ...
                    try {
                        ...
                        w.args = ES5('JSON', 'stringify', false, x)
                            .substring(0, 200);
                        n(w);
                    }
                };
        ...
        __d("sdk.Auth", ["sdk.Cookie", "copyProperties", "sdk.createIframe", "DOMWrapper", "sdk.getContextType", "guid", "ObservableMixin", "QueryString", "sdk.Runtime", "sdk.SignedRequest", "UrlMap", "URL", "sdk.XD"], function(a, b, c, d, e, f) {
            ...
            function y(aa, ba, ca) {
                return function(da) {
                    ...
                    if (da && da.access_token) {
                        ...
                        if (o.getUseCookie()) {
                            var ga = ba.expiresIn === 0 ? 0 : (new Date())
                                .getTime() + ba.expiresIn * 1000,
                                ha = g.getDomain();
            ...
            function z(aa) {
                ...
                var ca = y(aa, t, 'login_status'),
                    da = r(q.resolve('www', true) + '/dialog/oauth')
                        .setSearch(n.encode({
        ...
        FB.provide('Dialog', {
            ...
            _setDialogSizes: function() {
                ...
                for (var a in FB.Dialog._dialogs) if (document.getElementById(a)) {
                    ...
                    b.style.width = FB.UIServer.getDefaultSize()
                        .width + 'px';
                    b.style.height = FB.UIServer.getDefaultSize()
                        .height + 'px';
                }
            },
            _handleOrientationChange: function(a) {
                ...
                } else for (var b in FB.Dialog._dialogs) if (document.getElementById(b)) document.getElementById(b)
                    .style.width = FB.UIServer.getDefaultSize()
                    .width + 'px';
            },
            ...
            show: function(a) {
                ...
                if (b) {
                    ...
                    if ('fbCallID' in a) FB.Dialog.get(a.fbCallID)
                        .fire('iframe_show');
                }
            },
            hide: function(a) {
        ...
        FB.provide('UIServer', {
            ...
            getDisplayMode: function(a, b) {
                ...
                var c = FB.require('SDKConfig')
                    .useAsync ? FB._inCanvas : FB.Canvas.isTabIframe();
        ...
        __d("IframePlugin", ["sdk.DOM", "sdk.Event", "FB", "ObservableMixin", "PluginTags", "QueryString", "sdk.Runtime", "Type", "UrlMap", "sdk.XD", "XFBML", "guid", "insertIframe", "resolveURI"], function(a, b, c, d, e, f) {
            ...
            var x = {
                ...
                px: function(ba) {
                    return (/^(\d+)(?:px)?$/)
                        .test(ba) ? parseInt(RegExp.$1, 10) : undefined;
                },
                text: function(ba) {
                    return ba;
                }
        ...
        __d("RegisterTags", ["PluginCustomClass", "XFBML"], function(a, b, c, d, e, f) {
            ...
            function i(j) {
                return j.length > 0 ? j.charAt(0)
                    .toUpperCase() + j.substr(1) : '';
            }
            ES5(g, 'forEach', true, function(j) {
                h.registerTag({
                    xmlns: 'fb',
                    localName: j,
                    className: 'FB.XFBML.' + ES5(j.split('-'), 'map', true, i)
                        .join('')
                });
            });
        });
        ...
        FB.subclass('Data.Query', 'Waitable', function() {
            ...
            toFql: function() {
                ...
                case 'in':
                    ...
                    } else a += this.where.key + ' in (' + ES5(this.where.value, 'map', true, this._encode)
                        .join(',') + ')';
                    break;
                }
                return a;
        ...
        FB.subclass('TemplateUI', 'Obj', function(a, b) {
            ...
            use: function(a) {
                ...
                FB.UIServer.getLoadedNode(a)
                    .fbCallID = this.cachedCall.id;
                ...
                d.common = FB.TemplateData.getData()
                    .common;
        ...
        FB.subclass('XFBML.IframeWidget', 'XFBML.Element', null, {
            ...
            _arbiterInform: function(event, a, b) {
                var c = 'parent.frames["' + this.getIframeNode()
                    .name + '"]';
            ...
            _getURL: function() {
                ...
                return FB.getDomain(a) + 'plugins/' + b + this.getUrlBits()
                    .name + '.php';
            },
        ...
        FB.subclass('XFBML.Comments', 'XFBML.IframeWidget', null, {
            ...
            setupAndValidate: function() {
                ...
                if (!a.href) {
                    ...
                    if (!c) {
                        c = FB.QS.decode(document.URL.substring(ES5(document.URL, 'indexOf', true, '?') + 1))
                            .fb_comment_id;
            ...
            process: function() {
                ...
                FB.Event.monitor('auth.statusChange', ES5(this, 'bind', true, function() {
                    ...
                    if (FB.Runtime.getLoginStatus() !== 'unknown' && f) {
                        FB.Data._selectByIndex(['name', b], FB.Helper.isUser(f) ? 'user' : 'profile', FB.Helper.isUser(f) ? 'uid' : 'id', f)
                            .wait(g);
                    } else g();
                }));
            }
