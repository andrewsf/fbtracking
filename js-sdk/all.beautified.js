/*1360122950,178520881,JIT Construction: v729873,en_US*/
...
try {
    window.FB || (function(window) {
        ...
        __d("ConnectBarConfig", [], {
            "imgs": {
                "buttonUrl": "http:\/\/m-static.ak.fbcdn.net\/rsrc.php\/v2\/yY\/r\/h_Y6u1wrZPW.png",
                "missingProfileUrl": "http:\/\/m-static.ak.fbcdn.net\/rsrc.php\/v2\/yo\/r\/UlIqmHJn-SK.gif"
            }
        });
        __d("ProfilePicConfig", [], {
            "defPicMap": {
                "pic": "http:\/\/m-static.ak.fbcdn.net\/rsrc.php\/v1\/yh\/r\/C5yt7Cqf3zU.jpg",
                "pic_big": "http:\/\/m-static.ak.fbcdn.net\/rsrc.php\/v2\/yL\/r\/HsTZSDw4avx.gif",
                "pic_big_with_logo": "http:\/\/m-static.ak.fbcdn.net\/rsrc.php\/v2\/y5\/r\/SRDCaeCL7hM.gif",
                "pic_small": "http:\/\/m-static.ak.fbcdn.net\/rsrc.php\/v1\/yi\/r\/odA9sNLrE86.jpg",
                "pic_small_with_logo": "http:\/\/m-static.ak.fbcdn.net\/rsrc.php\/v2\/yD\/r\/k1xiRXKnlGd.gif",
                "pic_square": "http:\/\/m-static.ak.fbcdn.net\/rsrc.php\/v2\/yo\/r\/UlIqmHJn-SK.gif",
                "pic_square_with_logo": "http:\/\/m-static.ak.fbcdn.net\/rsrc.php\/v2\/yX\/r\/9dYJBPDHXwZ.gif",
                "pic_with_logo": "http:\/\/m-static.ak.fbcdn.net\/rsrc.php\/v2\/yu\/r\/fPPR9f2FJ3t.gif"
            }
        });
        __d("ApiClientConfig", [], {
            "FlashRequest": {
        ...
        __d("sdk.Auth", ["sdk.Cookie", "copyProperties", "sdk.createIframe", "DOMWrapper", "sdk.getContextType", "guid", "Log", "ObservableMixin", "QueryString", "sdk.Runtime", "sdk.SignedRequest", "UrlMap", "URL", "sdk.XD"], function(a, b, c, d, e, f) {
            ...
            function aa(da) {
                ...
                var fa = z(da, u, 'login_status'),
                    ga = s(r.resolve('www', true) + '/dialog/oauth')
                        .setSearch(o.encode({
        ...
        __d("sdk.Scribe", ["UrlMap", "QueryString"], function(a, b, c, d, e, f) {
            ...
            function i(k, l) {
                (new Image())
                    .src = h.appendToUrl(g.resolve('www', true) + '/common/scribe_endpoint.php', {
                    c: k,
                    ...
                    try {
                        ...
                        var z = ES5(Array.prototype.slice.call(arguments), 'map', true, function(aa) {
                            ...
                            return (/^\[object (String|Number|Boolean|Object|Date)\]$/)
                                .test(ba) ? aa : aa.toString();
                        });
                        y.args = ES5('JSON', 'stringify', false, z)
                            .substring(0, 200);
                        o(y);
                    } finally {
                        n = '';
            ...
            var g = b('sdk.Arbiter'),
                ...
                u = m.extend({
                    ...
                    _arbiterInform: function(event, aa, ba) {
                        var ca = 'parent.frames["' + this.getIframeNode()
                            .name + '"]';
                    ...
                    process: function(aa) {
                        ...
                        var ba = this.getSize() || {}, ca = this.getFullyQualifiedURL();
                    ...
                    _getURL: function() {
                        var aa = this.getDefaultWebDomain(),
                            ba = '';
                        return aa + '/plugins/' + ba + this.getUrlBits()
                            .name + '.php';
                    },
