/*1356674012,179363921,JIT Construction: v702819,en_US*/
    ...
    window.FB || (function(window) {
        ...
        __d("sdk.DOM", ["Assert", "createArrayFrom", "DOMEventListener", "sdk.domReady", "UserAgent"], function(a, b, c, d, e, f) {
            ...
            function s(aa, ba) {
                ...
                aa.className = ES5(o(aa, 'className')
                ...
                r = {
                    ...
                    _setDialogSizes: function() {
                        ...
                        for (var s in r._dialogs) if (r._dialogs.hasOwnProperty(s)) {
                            ...
                            if (t) {
                                t.style.width = r.getDefaultSize()
                                    .width + 'px';
                                t.style.height = r.getDefaultSize()
                                    .height + 'px';
                            }
                        }
                    },
                    ...
                    show: function(s) {
                        ...
                        if (t) {
                            ...
                            r._makeActive(t);
                            r._stack.push(t);
                            if ('fbCallID' in s) r.get(s.fbCallID)
                                .inform('iframe_show');
                        }
                    },
                    hide: function(s) {
        ...
        __d("IframePlugin", ["sdk.Auth", "sdk.DOM", "sdk.Event", "ObservableMixin", "PluginPipe", "QueryString", "sdk.Runtime", "Type", "UrlMap", "sdk.XD", "guid", "insertIframe", "resolveURI"], function(a, b, c, d, e, f) {
            ...
            var w = {
                ...
                px: function(aa) {
                    return (/^(\d+)(?:px)?$/)
                        .test(aa) ? parseInt(RegExp.$1, 10) : undefined;
                },
                text: function(aa) {
                    return aa;
                }
